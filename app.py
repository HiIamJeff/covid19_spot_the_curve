    ...
    html.Div(className="row", children=[
        html.Div(className='four columns', children=[
            ...
            html.P(
                ...
                across countries), I made 
                the metric here as the “Infection Rate” (the number of confirmed cases per 1 million people).
...
def goplot(n_clicks, country_selection1, country_selection2, country_selection3, country_selection4):
